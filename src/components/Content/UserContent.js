  ...
  return (
    <div className={collapsed ? "content_collapsed" : "content"}>
      <Switch>
        ...
        <Route exact path="/user/cash_statement_report" component={CashStatementReport} />
        <Route exact path="/user/expire_medicine_report" component={ExpireMedicineReport} />
        <Route exact path="/user/stock_report" component={StockReport} />
        <Route exact path="/user/sales_report" component={SalesReport} />
        <Route exact path="/user/purchases_report" component={PurchasesReport} />
        ...
        <Route exact path="/user/customer_due_report" component={CustomerDueReport} />
        <Route exact path="/user/bank_statement" component={BankStatement} />
        <Route exact path="/user/collection_report" component={CollectionReport} />
        ...
        <Route exact path="/user/employee_expense" component={EmployeeExpense} />
        <Route exact path="/user/employee_ledger" component={EmployeeLedger} />
        <Route exact path="/user/employee_salary_sheet" component={EmployeeSalarySheet} />
        ...
        <Route exact path="/user/expense_head_report" component={ExpenseHeadReport} />
